...
import { auth, query, executeActions, queryV3 } from ".";
...
export const createPaymentLink = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `paymentlink/addpaymentlink/${
...
export const updatePaymentLink = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `paymentlink/updatepaymentlink/${
                getState().data.business_details.number
            }`,
            data: postData.data,
            // location: postData.location,
...
export const walletTopUp = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `business/generate/walletpaymentlink/${
                getState().data.business_details.number
            }`,
            data: postData.data,
            location: postData.location,
...
export const refundTransfer = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `business/pocketprofile/${
                getState().data.business_details.number
            }/transfer/reverse/${postData.transRef}`,
            data: postData.data,
            location: postData.location,
...
export const transferSettlementFund = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `business/${getState().data.business_details.number}/settlements/${
                postData.data.cycleRef
            }/pushtobank`,
            data: postData.data,
            location: postData.location,
    ...
    executeActions(
        {
            URL: !postData.size
                ...
                : `business/pocketprofile/${
                    getState().data.business_details.number
                }/customerprofiles/search?page=${
                    postData ? (postData.start - 1) * postData.size : 0
    ...
    query(
        {
            URL: `business/${
                getState().data.business_details.number
            }/customerprofiles/search?q=${postData.search_term}&start_date=${
                postData.start_date
            }&stop_date=${postData.stop_date}&page=${
                (postData.page - 1) * postData.size || 0
            }&size=${postData.size || 25}`,
            name: "wallet_payouts",
        },
        dispatch
    );
    ...
    executeActions(
        {
            URL: !postData.imageId
                ? postData.multiple
                    ? `products/business/${
                        getState().data.business_details.number
                    }/product/${postData.id}/uploadmultipleimages`
                    : `products/business/${
                        getState().data.business_details.number
                    }/product/${postData.id}/uploadimage`
                : `products/business/${
                    getState().data.business_details.number
                }/product/${postData.id}/uploadimage/${postData.imageId}`,
            data: postData.data,
            location: postData.location,
...
export const updateCategory = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `products/business/categories/business/${
                getState().data.business_details.number
            }/cat/${postData.id}`,
            data: postData.data,
            location: postData.location,
...
export const addCategory = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `products/business/categories/${
                getState().data.business_details.number
            }`,
            data: postData.data,
    ...
    executeActions(
        {
            URL: `business/addbusiness/${
                getState().data.user_details.id
            }/newbusiness/${getState().data.business_details.number}`,
            data: postData.data,
            location: postData.location,
            name: "new_business",
            type: "POST",
    ...
    executeActions(
        {
            URL: `business/branch/${
                getState().data.business_details.number
            }/assignaccount/${postData.branchId}`,
            data: postData.data,
            location: postData.location,
...
export const updateBranch = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `business/branch/${getState().data.business_details.number}/branch/${
                postData.id
            }`,
            data: postData.data,
            location: postData.location,
...
export const addBusinessAdvert = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `business/addcheckoutadvert/${
                getState().data.business_details.number
            }`,
            data: postData.data,
            location: postData.location,
...
export const setCheckoutAdsStatus = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `business/checkoutadvert/changestatus/${
                getState().data.business_details.number
...
export const updateFrontStore = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `store/updatestore/${getState().data.business_details.number}/${
                postData.storeId
            }`,
            data: postData.data,
            location: postData.location,
    ...
    executeActions(
        {
            URL: `store/updateorderstatus/${
                getState().data.business_details.number
            }/${postData.storeId}/${postData.transactionRef}`,
            data: postData.data,
            location: postData.location,
...
export const updateTheme = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `store/updatetheme/${getState().data.business_details.number}/${
                postData.storeId
            }`,
            data: postData.data,
...
export const updateSingleAdsStatus = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `business/checkoutadvert/${
                getState().data.business_details.number
            }/advert/${postData.id}?status=${postData.status}`,
...
export const updateBusinessAdvert = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `business/updatecheckoutadvert/${
                getState().data.business_details.number
            }`,
            data: postData.data,
            location: postData.location,
...
export const replyDispute = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `user/${getState().data.business_details.number}/disputes/${
                postData.url.dispute_ref
            }/${postData.url.action}`,
            data: postData.data,
            location: postData.location,
            name: "dispute",
    ...
    executeActions(
        {
            URL: `transaction/${
                getState().data.business_details.number
            }/sendreport?startDate=${postData.start_date}&endDate=${
                postData.stop_date
            }&type=${postData.type}`,
            data: postData.data,
            location: postData.location,
...
export const loadProductOrders = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `store/loadorders/${getState().data.business_details.number}/${
                postData.storeId
            }?size=${postData ? postData.size : 25}&page=${
                postData ? (postData.start - 1) * postData.size : 0
            }&q=ALL&startDate=&endDate=`,
            name: "store_orders",
        },
        dispatch
    );
...
export const loadProductOrdersDetails = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `store/loadordersitems/${getState().data.business_details.number}/${
                postData.storeId
...
export const getDeliveryZone = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `store/getdeliveryregion/${
                getState().data.business_details.number
            }/${postData.storeId}?size=${postData ? postData.size : 25}&page=${
                postData ? (postData.start - 1) * postData.size : 0
            }`,
...
export const validateCustomUrl = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `paymentlink/validatecustomurl/${
                getState().data.business_details.number
            }/${postData.data}`,
...
export const getStoreDetails = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `store/getstore/${getState().data.business_details.number}?size=${
                postData ? postData.size : 25
            }&page=${postData ? (postData.start - 1) * postData.size : 0}&storeName=${
                postData.storeName || "ALL"
            }`,
            name: "store_details",
        },
        dispatch
...
export const getPaymentLinks = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `paymentlink/getpaylink/${
                getState().data.business_details.number
            }/ByBusinessId/${getState().data.business_details.number}?page=${
                postData ? (postData.start - 1) * postData.size : 0
            }&size=${postData ? postData.size : 25}`,
...
export const createStoreSettings = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `store/updateadvancedconfig/${
                getState().data.business_details.number
            }/${postData.storeId}`,
            data: postData.data,
            location: postData.location,
...
export const createGeneralStoreSettings =
    (postData) => (dispatch, getState) => {
        executeActions(
            {
                URL: `store/updategeneralconfig/${
                    getState().data.business_details.number
                }/${postData.storeId}`,
                data: postData.data,
                location: postData.location,
...
export const getTheme = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `store/gettheme?size=${postData ? postData.size : 25}&page=${
                postData ? (postData.start - 1) * postData.size : 0
            }`,
            name: "store_theme",
        },
...
export const loadStoreProducts = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `store/loadproducts/${getState().data.business_details.number}/${
                postData.storeId
            }?size=${postData && postData.size ? postData.size : 25}&page=${
                postData && postData.size && postData.start
                    ? (postData.start - 1) * postData.size
                    : 0
            }&productName=&status=&startDate=&endDate`,
            name: "store_products",
        },
        dispatch
    );
...
export const getCoupon = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `store/getcoupon/${getState().data.business_details.number}/${
                postData.storeId
            }?size=${postData ? postData.size : 25}&page=${
                postData ? (postData.start - 1) * postData.size : 0
            }&couponCode=all&couponType=all&startDate=&endDate=`,
            name: "get_coupon",
        },
        dispatch
    );
...
export const loadAllStoreDetails = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `store/getstorebyid/${getState().data.business_details.number}/${
                postData.storeId
            }`,
    ...
    query(
        {
            URL: `paymentlink/getpaylink/${
                getState().data.business_details.number
            }/ByBusinessId/${getState().data.business_details.number}${
                postData.param ? "/PaymentLinkName/" + postData.param : ""
            }?page=${postData ? postData.start : 0}&size=${
                postData ? postData.size : 25
            }`,
...
export const getDispute = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `user/${getState().data.business_details.number}/disputes/ref/${
                postData.ref
            }`,
            name: "single_dispute",
            parent_value: true,
    ...
    query(
        {
            URL: `business/pocketprofile/${
                getState().data.business_details.number
            }/customerprofiles?page=${postData ? postData.start - 1 : 0}&size=${
                postData ? postData.size : 25
            }`,
...
export const getPocketCustomerTransactions =
    (postData) => (dispatch, getState) => {
        query(
            {
                URL: `business/pocketprofile/${
                    getState().data.business_details.number
                }/pocket/${postData.pocketReferenceId}?type=${postData.type}&page=${
    ...
    query(
        {
            URL: `business/pocketprofile/${
                getState().data.business_details.number
            }/merchantpocket?type=${postData.type}&page=${
                postData ? (postData.start - 1) * postData.size : 0
            }&size=${postData ? postData.size : 25}`,
            ...
            queryV3(
                {
                    URL: cur
                        ? `user/${
                            getState().data.business_details.number
                        }/transactions?page=${transformed_from}&size=${to}&cur=${cur}&type=${type}`
                        : `user/${
                            getState().data.business_details.number
                        }/transactions?page=${(from - 1) * to}&size=${to}&type=${type}`,
                    name: "transactions",
                    parent_value: true,
                },
                dispatch
            ...
            query(
                {
                    URL: `user/${
                        getState().data.business_details.number
                    }/transactions/start/${from}/stop/${to}/?page=${
                        (start - 1) * size
...
export const getTransactionRange = (postData) => (dispatch, getState) => {
    getState().data.business_details &&
    query(
        {
            URL: `user/${
                getState().data.business_details.number
            }/transactions/range/${postData.DAY}/${postData.DATE}/${
                postData.LENGTH
            }`,
...
export const searchProducts =
    (from, to, search_term = "", type = false) =>
        (dispatch) => {
            query(
                {
                    URL: `products/business/${
...
export const searchTransactions =
    (
        ...
        (dispatch, getState) => {
            ...
            queryV3(
                {
                    URL: `business/${getState().data.business_details.number}/transactions/search?page=${from - 1}&size=${to}&mode=${getState().data.business_details.setting.mode}&withCount=false`,
                    data: {
                        "startDate": start_date || null,
                        "endDate": stop_date || null,
                        "currency": currency || getState().data.business_details.default_currency,
                        "productId": productId || null,
                        "transactionRef": transactionReference || null,
                        "transactionType": type || "ALL",
                        "channel": selectedpaymentOption
                    },
                    name: "transactions",
                    parent_value: true,
                },
...
export const getSingleTransaction = async (id, businessNumber) => {
    const state = loadState().user.data;
    const url = `${BASE_URL_V3}business/${businessNumber}/transactions/${id}`;
    return axios(
        url,
        {
            method: "GET",
...
export const getTransaction = (id) => (dispatch, getState) => {
    query({
        URL: `${BASE_URL_V3}business/${getState().data.business_details.number}/transactions/${id}`,
        name: 'transaction'
    }, dispatch);
}
...
export const getRefunds = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `user/${getState().data.business_details.number}/refunds?page=${
                postData ? (postData.start - 1) * postData.size : 0
            }&size=${postData ? postData.size : 25}`,
            name: "refunds",
        },
    ...
    query(
        {
            URL: `products/business/categories/${
                getState().data.business_details.number
            }/?page=${postData ? (postData.start - 1) * postData.size : 0}&size=${
                postData ? postData.size : 25
            }`,
    ...
    query(
        {
            URL: `products/business/${
                getState().data.business_details.number
            }/?page=${postData ? postData.start - 1 : 0}&size=${
                postData ? postData.size : 25
            }`,
            name: "products",
            parent_value: true,
...
export const getPayouts = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `user/${getState().data.business_details.number}/settlement?page=${
                postData ? (postData.start - 1) * postData.size : 0
            }&size=${postData ? postData.size : 25}${
                postData && postData.cur ? `&cur=${postData.cur}` : ""
            }`,
            name: "payouts",
            parent_value: true,
        },
...
export const getCustomers = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `user/${getState().data.business_details.number}/customers?page=${
                postData ? (postData.start - 1) * postData.size : 0
    ...
    query(
        {
            URL: `transaction/${
                getState().data.business_details.number
            }/searchcustomers?search=${postData.param}`,
            name: "customers",
            parent_value: true,
        },
        dispatch
    ...
    query(
        {
            URL: `business/${
                getState().data.business_details.number
            }/refunds/search?q=${postData.search_term}&start_date=${
                postData.start_date
            }&stop_date=${postData.stop_date}${
                postData.refundSource ? "&type=" + postData.refundSource : ""
            }&page=${postData.page - 1 || 0}&size=${postData.size || 2}`,
            name: "refunds",
        },
        dispatch
    );
    ...
    query(
        {
            URL: postData.start_date
                ? `subaccount/subaccountsettlements/${
                    getState().data.business_details.number
                }/${postData.subAccountId}
      ?startDate=${postData.start_date}&endDate=${postData.stop_date}&size=${
                    postData ? postData.size : 25
    ...
    executeActions(
        {
            URL: `user/${
                getState().data.business_details.number
            }/disputes/searchv2?page=${postData ? postData.page - 1 : 0}&size=${
                postData ? postData.size : 25
            }`,
            data: data,
            name: postData.location,
...
export const deleteSplitAccount = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `subaccount/deletesubaccountsetup/${
                getState().data.business_details.number
            }/${postData.id}`,
            location: postData.location,
...
export const getVendorTransactions = (postData) => (dispatch, getState) => {
    query(
        {
            URL: postData.start_date
                ? `subaccount/transactions/${getState().data.business_details.number}/${
                    postData.subAccountId
                }?startDate=${postData.start_date}&endDate=${
                    postData.stop_date
                }&size=${postData ? postData.size : 25}&page=${
                    postData ? (postData.start - 1) * postData.size : 0
                }&type=all`
...
export const getVendorTransactionOverview =
    (postData) => (dispatch, getState) => {
        query(
            {
                URL: !postData.start_date
                    ? `subaccount/transactions/summary/${
                        getState().data.business_details.number
                    }/${postData.subAccountId}`
                    : `subaccount/transactions/summary/${
                        getState().data.business_details.number
                    }/${postData.subAccountId}?startDate=${
                        postData.start_date
                    }&endDate=${postData.stop_date}`,
    ...
    query(
        {
            URL:
                postData && postData.type
                    ? `subaccount/getallsubaccountsetup/${
                        getState().data.business_details.number
                    }/search?size=${postData ? postData.size : 25}&page=${
                        postData ? (postData.start - 1) * postData.size : 0
                    }&type=${postData && postData.type}`
                    : `subaccount/getallsubaccountsetup/${
                        getState().data.business_details.number
                    }?size=${postData ? postData.size : 25}&page=${
                        postData ? (postData.start - 1) * postData.size : 0
...
export const searchVendor = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `subaccount/getallsubaccountsetup/${
                getState().data.business_details.number
    ...
    query(
        {
            URL: `business/${
                getState().data.business_details.number
            }/settlements/search?q=${postData.search_term}&start_date=${
                postData.start_date
            }&stop_date=${postData.stop_date}&page=${
                (postData.page - 1) * postData.size || 0
            }&size=${postData.size || 25}`,
...
export const getSettlementTransaction = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `user/${getState().data.business_details.number}/settlement/${
                postData.cycleRef
...
export const getBranchTransactions =
    (branchNumber, from = 1, to = 25, type = "ALL") =>
        (dispatch, getState) => {
            query(
                {
                    URL: `business/branches/transactions/${
                        getState().data.business_details.number
                    }/branch/${branchNumber}?page=${
                        (from - 1) * to
                    }&size=${to}&type=${type}`,
...
export const getBranchSettlementTransactions =
    (postData) => (dispatch, getState) => {
        query(
            {
                URL: `business/branch/${
                    getState().data.business_details.number
                }/settlement/${postData.cycleRef}/ref/${postData.branchRef}`,
                name: "settlement_transactions",
                parent_value: true,
            },
            dispatch
...
export const getDisputes = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `user/${getState().data.business_details.number}/disputes?page=${
                postData ? (postData.start - 1) * postData.size : 0
            }&size=${postData ? postData.size : 25}`,
            name: "disputes",
            parent_value: true,
...
export const getBranchPayout = (postData) => (dispatch, getState) => {
    query(
        {
            URL: `business/branch/settlement/${
                getState().data.business_details.number
            }/branch/${postData.branch}?page=${
                postData ? (postData.start - 1) * postData.size : 0
            }&size=${postData ? postData.size : 25}`,
            name: "branch_payout",
        },
...
export const getBankList = (postData) => (dispatch, getState) => {
    ...
    query(
        {
            URL: `banks/country/${bizCountry || "NG"}?p=false`,
            name: "bank_list",
        },
        dispatch
    );
...
export const createSplitAccount = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `subaccount/postsubaccountsetup/${
                getState().data.business_details.number
            }`,
    ...
    executeActions(
        {
            URL: `transaction/${
                getState().data.business_details.number
            }/sendreport/link?transactionType=${postData.status}`,
            name: "request_report",
            data: postData.data,
            location: postData.location,
            type: "POST",
...
export const updateSplitAccount = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `subaccount/updatesubaccountsetup/${
                getState().data.business_details.number
            }/${postData.subAccountId}`,
...
export const fixUserToBranch = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `user/assignbranch/${getState().data.business_details.number}/user/${
                postData.userId
            }/branch/${postData.branchNumber}?status=${postData.mode}`,
            data: postData.data,
            location: postData.location,
            name: "user",
            type: "PUT",
...
export const switchUserMode = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `user/switchaccountmode/${
                getState().data.business_details.number
            }/user/${postData.userId}?${postData.type}`,
            data: postData.data,
            location: postData.location,
...
export const saveBusinessDetails = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `user/updatebusinessdetails/${
                getState().data.business_details.number
            }/${postData.userId}`,
            data: postData.data,
            location: postData.location,
...
export const saveBusinessSupport = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `user/updatebusinesssupport/${
                getState().data.business_details.number
            }/${postData.userId}`,
            data: postData.data,
            location: postData.location,
...
export const saveBusinessSettlements = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `user/updatebusinesssettlement/${
                getState().data.business_details.number
            }/${postData.userId}`,
            data: postData.data,
            location: postData.location,
...
export const saveBusinessKyc = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `user/updatebusinesscertificate/${
                getState().data.business_details.number
            }/${postData.userId}`,
            data: postData.data,
            location: postData.location,
            ...
            URL:
                postData.type === "setting"
                    ...
                    : postData.type === "settlement_email"
                        ? `business/${
                            getState().data.business_details.number
                        }/addupdateSettlementEmailList`
                        : `user/${getState().data.user_details.id}/business/${
                            getState().data.business_details.number
                        }`,
            data: postData.data,
            location: postData.location,
...
export const switchMode = (postData) => (dispatch, getState) => {
    executeActions(
        {
            URL: `user/switchmode/${getState().data.user_details.id}/business/${
                getState().data.business_details.number
            }`,
            data: postData.data,
            location: postData.location,
...
export const dispatchUserDetails = (user_details) => (dispatch, getState) => {
    dispatch({
        ...
        payload: {
            ...
            location: "login",
            business_details: Array.isArray(user_details.payload.businessList)
                ? user_details.payload.businessList.length === 1
                    ? user_details.payload.businessList[0].business
                    : {}
                : {},
            user_permissions: Array.isArray(user_details.payload.businessList)
                ? user_details.payload.businessList.length === 1
